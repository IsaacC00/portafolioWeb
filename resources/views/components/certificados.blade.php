@props(['services'])
<section class="text-gray-400 body-font container mx-auto">
    <div class=" px-5 py-10 w-full ">
        <div class="flex flex-col text-center w-full mb-20">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 items-center justify-center mx-auto">
                    ...
                    <div class="relative mx-auto text-center flex flex-col mt-6 text-gray-700 bg-white shadow-md bg-clip-border rounded-xl w-96 ">
                        <div class="p-6 ">
                            <img alt=""
