<div class="  bg-cover bg-center h-full" style="background-image: url({{asset('img/final.png')}})">
    <div class="bg-white bg-opacity-20 py-24 mx-auto">
        ...
        <div class="lg:w-1/2 md:w-2/3 mx-auto">
            <div class="bg-black bg-opacity-90 p-6 rounded-lg h-full flex items-start">
                ...
                <form action="{{route('contac.send')}}" method="POST" class="flex flex-wrap -m-2" autocomplete="off">
                    ...
                    <div class="p-2 w-full">
                        ...
                        <div class="relative">
                            ...
                            <textarea name="mensaje" id="mensaje"
                                class="w-full rounded border border-slate-800 h-32 text-base outline-none py-1 px-3 resize-none leading-6">{{ old('mensaje') }}</textarea>
                        </div>
                    ...
                    <div class="p-4 w-full">
                        ...
                        <button type="submit"
                            ...
                            <span
                                class="absolute top-0 left-0 flex w-full h-0 mb-0 transition-all duration-200 ease-out transform translate-y-0 bg-orange-600 group-hover:h-full opacity-90"></span>
