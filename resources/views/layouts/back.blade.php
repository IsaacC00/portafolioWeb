...
<body>
    ...
    <div class="relative min-h-screen md:flex">
        ...
        <div class="bg-gray-800 text-gray-100 flex justify-between md:hidden">
            {{-- logo --}}
            <a href="" class="block p-4 text-white font-extrabold">Administrador</a>
            {{-- menu boton --}}
        ...
        inset-y-0 left-0 transform-translate-x-full md:translate-x-0  md:relative transition duration-200 ease-in-out ">
            ...
            <h1 href="" class="text-white flex items-center space-x-2">
                ...
                <span class="font-extrabold text-2xl">Adminitrador</span>
            ...
            <nav>
                ...
                <a href="{{route('admin.services.index')}}" class="block py-2.5 px-4 flex items-center space-x-2 hover:bg-gray-700  rounded-md
                transition duration-200 hover:text-white">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="w-6 h-6">
                        <path stroke-linecap="round" stroke-linejoin="round"
                ...
                {{-- Usuario --}}
                <div class="mt-7">
                    <h1 class="text-base block py-0 px-4 uppercase font-bold">USUARIO</h1>

                    <a href="{{route('admin.user')}}" class="block py-2.5 px-4 flex items-center space-x-2 hover:bg-gray-700  rounded-md
                    transition duration-200 hover:text-white">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" class="w-6 h-6">
                            <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <form method="POST" action="{{route('logout')}}">
                        @csrf
                        <button type="submit" class="block py-2.5 px-4 flex items-center space-x-2 hover:bg-gray-700  rounded-md
                        transition duration-200 w-full hover:text-white" tabindex="-1" id="user-menu-item-2">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                stroke="currentColor" class="w-6 h-6">
                                <path stroke-linecap="round" stroke-linejoin="round"
