...
<div class=" px-6 lg:px-16">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 ">
        ...
        <div class="col-span-1 p-2 object-cover object-center">
            <img class="zoomable cursor-pointer" src="{{ Storage::url($image->image_path) }}" alt="Image alt">
        </div>
        @endforeach
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-5">
        ...
        <aside>
            ...
            <div class="mb-4">
                <a class="flex" href="{{route('posts.show',$igual)}}">
                    <img class="w-36 justify-start object-contain"
                        src="{{ Storage::url($igual->images->first()->image_path) }}" alt="">
