...
<div class=" bg-white p-6 rounded-lg shadow-xl">
    ...
    {!! Form::text('telefono', null, ['class'=>'my-4 text-base border p-3 w-full
    rounded-lg','placeholder'=>'0922334455']) !!}
    @error('telefono')
    ...
    {!! Form::text('facebook', null, ['class'=>'my-4 text-base border p-3 w-full
    rounded-lg','placeholder'=>'John-Mark']) !!}
    @error('facebook')
    <p class="bg-red-500 text-white my-2 
                rounded-lg text-sm p-2 text-center">{{$message}}</p>
    @enderror
    ...
    {!! Form::text('instagram', null, ['class'=>'my-4 text-base border p-3 w-full
    rounded-lg','placeholder'=>'cr7cristianoronaldo']) !!}
    @error('instagram')
    <p class="bg-red-500 text-white my-2 
                rounded-lg text-sm p-2 text-center">{{$message}}</p>
    @enderror
    ...
    <div class="my-5 flex flex-row space-x-2">
        {!! Form::label('descripcion', 'Descripcion Personal',['class'=>'mb-2 block text-gray-500 font-bold text-base
        uppercase']) !!}
                {{-- Toltip --}}
                <div>
                    <span class="group relative">
    ...
    {!! Form::submit('Agregar Informacion', ['class'=>'bg-purple-600 rounded-md text-sm text-white p-2.5
    cursor-pointer'])
    !!}
    {!! Form::close() !!}
</div>
...
<script>
    // Delegación de eventos para los botones de tooltip
    document.body.addEventListener('mouseover', function(event) {
        if (event.target.matches('.tooltip-btn')) {
